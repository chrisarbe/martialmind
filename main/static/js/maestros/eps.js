window.onload = function() {
    ...
    document.getElementById("menu_eps").setAttribute("class", "submenu-item active");
};

function eps_borrar(pk) {
        ...
        success: function (data) {
            if(data.status != "1") {
                ...
                Swal.fire({
                    ...
                    confirmButtonText: '<a href="/eps/">Aceptar</a>'
                });
            }
        }
    });
...
function eps_editar(pk) {
    ...
    $.ajax({
        ...
        $('#editar_eps').modal('show');
       });
}

function eps_editar_guardar() {
    const csrftoken = getCookie('csrftoken');
